"""
Django settings for hopin_38996 project.
...
WSGI_APPLICATION = 'hopin_38996.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "hopin_38996 API",
    "DESCRIPTION": "API documentation for hopin_38996 App",
    "VERSION": "v1",
}
